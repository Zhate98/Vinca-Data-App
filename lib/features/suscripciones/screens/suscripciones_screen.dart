          ...
          return ListView(
            ...
            children: [
              GridView.count(
                ...
                children: [
                  KpiCard(label: '💶 Mensual', value: Fmt.money(mensual), accent: AppColors.pink),
                  KpiCard(label: '📅 Anual', value: Fmt.money(mensual * 12), accent: AppColors.purple),
                ...
                for (final s in list)
                  Card(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text('${s.renovacion} · ${s.categoria}',
                          style: const TextStyle(fontSize: 11, color: AppColors.darkMuted)),
                      trailing: Row(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Text('${Fmt.money(s.precioMes)}/mes',
    ...
    showModalBottomSheet(
      ...
      builder: (_) => _SuscForm(
        ...
        onSubmit: (s) => suscripcion == null
            ? ref.read(financeRepositoryProvider)!.addSuscripcion(s)
            : ref.read(financeRepositoryProvider)!.updateSuscripcion(s),
      ),
    );
  }
}
...
class _SuscForm extends StatefulWidget {
  const _SuscForm({required this.onSubmit, this.suscripcion});
...
class _SuscFormState extends State<_SuscForm> {
  ...
  late String _persona = widget.suscripcion?.persona ?? FinanceConstants.personasBase.first;
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Precio/mes (€)'),
                validator: (v) =>
